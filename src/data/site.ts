...
export const projects: Project[] = [
  {
    slug: "flash-idea",
    title: "Flash Idea",
    subtitle: "端侧 AI 笔记 APP",
    summary: "面向移动端灵感记录场景的 AI 笔记产品探索，覆盖调研、产品定位、移动端页面与数据流设计。",
    period: "2026.04 - 2026.05",
    role: "队长 / 产品与技术负责人",
    type: "AI 竞赛项目 / Android App / AI 产品策划",
    facts: [
      "规划并带领团队完成前期调研、产品设计、技术方案、Agent 框架设计、协同开发与宣传材料产出。",
      "完成 6 轮市场调研与竞品分析，形成产品定位、功能优先级与版本路线。",
      "主导 Kotlin + Jetpack Compose 移动端方案，设计笔记列表、详情、AI 对话、图谱、洞察流等 7 个核心页面与数据流。"
    ],
    materials: [],
    images: []
  },
  {
    slug: "service-agent",
    title: "Service Agent",
    subtitle: "企业客服智能体解决方案",
    summary: "面向家装企业客服自动化场景，拆解需求并参与搭建获客、沟通、沉淀和销售跟进链路。",
    period: "2026.04 - 2026.05",
  ...
  },
  {
    ...
    subtitle: "深圳文博会数字博物馆网站",
    summary: "在深圳文博会现场对接企业需求，作为唯一技术开发人员推进数字博物馆网站原型与后续迭代。",
    ...
    images: [
      {
        ...
        alt: "Riven presenting a digital museum project at Shenzhen Cultural Expo",
        kind: "photo"
      }
    ]
  }
...
export const waytoagiEvents: EventNode[] = [
  {
    ...
    place: "广州",
    role: "技术指导（志愿者）",
    summary: "辅助参与者下载和配置 Codex，支持参与者在 90 分钟内完成创意实现与路演准备。",
    actions: ["辅助参与者下载和配置 Codex。", "帮助解决开发过程中的工具与环境问题。", "支持参与者完成创意实现与路演准备。"],
    images: [{ src: "/assets/events/guangzhou-codex.jpg", alt: "Guangzhou Codex event scene", kind: "photo" }]
  },
  {
    ...
    actions: ["辅助参与者配置 Codex。", "处理工具与环境问题。", "支持创意实现与路演准备。"],
    images: [{ src: "/assets/events/macau-codex.jpg", alt: "Macau Codex event scene", kind: "photo" }]
  },
  {
    ...
    actions: ["在团队中担任唯一技术开发人员。", "现场对接企业真实需求。", "会后持续迭代数字博物馆网站产品。"],
    result: "团队与 3 家企业取得后续合作意向。",
    images: [{ src: "/assets/events/culture-expo-roadshow.jpg", alt: "Shenzhen Cultural Expo roadshow", kind: "photo" }]
  },
  {
    ...
    role: "技术指导（志愿者）",
    summary: "帮助 Win/Mac 用户安装 Agent 环境，协助参与者联通飞书 CLI，收集现场工具使用问题。",
    actions: ["帮助 Win/Mac 用户安装 Agent 环境。", "协助参与者联通飞书 CLI。", "收集现场工具使用问题。"],
    images: [{ src: "/assets/events/feishu-cli-work.jpg", alt: "Riven helping participants at Feishu CLI event", kind: "photo" }]
  },
  {
    ...
    actions: ["参与社区 OpenClaw 主题活动。", "了解 OpenClaw 展位、部署和使用场景。"],
    images: [{ src: "/assets/events/openclaw-scene.jpg", alt: "OpenClaw themed community event", kind: "photo" }]
  },
  {
    ...
    place: "广州海珠区华新中心清智孵化器琶洲模方",
    role: "参与者",
    summary: "体验 NFC 个人简介卡片，在 Social 环节链接 AI 从业者和工具使用者，使用秒哒制作并提交 3 个网页作品。",
    actions: ["体验 NFC 个人简介卡片。", "在 Social 环节链接 AI 从业者和工具使用者。", "使用秒哒制作并提交 3 个网页作品。"],
    images: [{ src: "/assets/events/miaoda-meetup.jpg", alt: "Baidu Miaoda meetup group photo", kind: "photo" }]
  },
  {
    slug: "aipo-20251108",
    ...
    summary: "协同完成场地、邀约、现场流程和路演组织；作为参赛者路演项目获创业者第二名。",
    actions: ["协同完成场地、邀约、现场流程和路演组织。", "作为创业者上台路演并展示项目。"],
    result: "活动覆盖广州大学城及周边 10+ 高校、50+ 现场参与者。",
    images: [{ src: "/assets/events/aipo-poster.jpg", alt: "AIPO event poster", kind: "poster" }]
  }
];
...
export const capabilities = [
  {
    title: "Agent 应用与快速实现",
    items: ["常用 Codex、Claude Code、Cursor、VS Code 等开发工具", "Agent 框架设计", "需求拆解与任务编排", "前后端协作开发", "快速开发实现 demo", "接口联调与运行文档整理"]
  },
  {
    title: "产品与项目推进",
    items: ["市场调研与竞品分析", "产品定位与功能优先级", "页面结构与数据流设计", "宣传材料与交付材料制作", "从想法到可展示原型的推进"]
  },
  {
    title: "社区与活动运营",
    items: ["活动策划与环节设计", "现场人员分工与统筹", "面向技术小白的教学经验", "用户需求与反馈采集", "社区社群的运营与维护"]
  },
  {
    title: "内容与表达",
...
export const workExperience = [
  {
    ...
    summary: "负责广东地区线下社区运营，参与活动触达、用户维护、课程/产品推广与数据整理。",
    details: [
      "负责广东地区线下社区的社群运营、内容规划、活动触达、用户维护和课程 / 产品推广。",
      "参与线下活动从预热、邀约、通知、现场沟通到复盘的完整链路。",
      "使用飞书文档、飞书多维表格等工具进行活动宣发、用户反馈采集和数据整理。"
    ],
    metrics: ["累计服务 100+ 社区用户", "组织 2 场线下活动", "广东社区人数从 122 发展至 186，增长 64 人，增幅约 52%"],
    images: [{ src: "/assets/work/wavepeak-certificate.jpg", alt: "WavePeak internship certificate", kind: "document" as const }]
  }
];
